    ...
    public void validate() throws IOException {
        ...
        if((warning==9) && !warning3 && (warning2==2) && !warning4)
        {
            ...
            if (result.get() == ButtonType.OK) {
                ...
                String query = "INSERT INTO supplier(name, Address,city,country,postcode,telephone,fax,email,contactperson) VALUES ('" + txtName.getText() + "','" + txtAdd.getText() + "','" + txtCity.getText() + "','" + txtCon.getText() + "','" + txtPc.getText() + "','" + txtTn.getText() + "','" + txtFn.getText() + "','" + txtEmail.getText() + "','" + txtCp.getText() + "')";
                s.editS(query);
